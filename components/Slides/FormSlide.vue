      ...
      <div class="container_wrp">
        ...
        <form  class="relative z-5 p-4 shadow-2 form bg-card border-round  w-full"
          ...
          <div>
            ...
            <InputText v-model="form.phone" id="phone" type="text" class="w-full p-2 mb-3"/>

            <Button  @click="pay" :loading="loading" :label="loading ? 'Загрузка...' : 'Купить'"  class="w-full py-2 flex hoverable text-center mt-2"></Button>
          </div>
        </form>
      </div>
    </div>
