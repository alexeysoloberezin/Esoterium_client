...
<!--          <path  d="M8.19 56V16.4H44.325V20.855H12.645V33.945H38.11V38.455H12.645V51.545H44.325V56H8.19Z" fill="red"/>-->
<!--        </g>-->
        <g  class="startLoading-svg-e">
          <path d="M0 0H38V4.34286H4.88571V20.146H26.3889V21.7294V23.3127L4.88571 23.3429V36.9143H38V41.2571H0V0Z" fill="white"/>
          <path d="M25.3619 20.146H28.0008C28.8752 20.146 29.5841 20.8549 29.5841 21.7294V21.7294C29.5841 22.6038 28.8752 23.3127 28.0008 23.3127H25.3619V20.146Z" fill="white"/>
        </g>
...
@keyframes animate-sh {
  0%{
    transform: translate(30px, 22px) scale(0.1);
    opacity: 0;
  }
  30%{
    transform: translate(41px, 12px) scale(0.53);
    opacity: 1;
  }
  50%{
    transform: translate(41px, 12px) scale(0.53);
  ...
  100%{
    opacity: 1;
    transform: translate(-2px, 12px) scale(.87)
  }
}
</style>