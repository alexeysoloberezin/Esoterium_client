      ...
      <div class="card-body">
        <form  class="surface-card relative z-5 p-4 shadow-2 mx-auto  border-round  w-full"
          ...
          <div>
            ...
            <InputText v-model="index.email" id="em" type="text" class="w-full mb-3"/>

            <label for="name" class="block text-900 font-medium mb-2">Имя</label>
            <InputText v-model="index.name" id="name" type="text" class="w-full mb-3"/>

            <label for="phone" class="block text-900 font-medium mb-2">Телефон</label>
            <InputText v-model="index.phone" id="phone" type="text" class="w-full mb-3"/>
